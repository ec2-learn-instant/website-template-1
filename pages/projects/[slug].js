            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-xl-5 col-md-12 col-12 order-2 order-lg-1 mt_md--30 mt_sm--30">
                <div className="content">
                  <div className="inner">
                    <h2 className="title mb--20">Project brief</h2>
                    {caseStudyData.projectBreif2.description?.map(
                      (breif, index) => (
                        <p
                          key={`project-breif-${index}`}
                          className={
                            index !==
                            caseStudyData.projectBreif2.description.length - 1
                              ? "mb--30"
                              : ""
                          }
                        >
              ...
              <div className="col-lg-8 offset-lg-2">
                <div className="content">
                  <div className="section-title-inner text-start">
                    ...
                    {caseStudyData.solution.description?.map(
                      (solution, index) => (
                        <p
                          key={`project-solution-${index}`}
                          className={`subtitle-2 ${
                            index !==
                            caseStudyData.solution.description.length - 1
                              ? "mb--30"
                              : ""
                          }`}
                        >
