    ...
    <>
      ...
      {postType === "gallery" && (
        <div className="axil-blog-list gallery-post">
          ...
          <div className="thumbnail axil-carousel axil-arrow-button botton-bottom-transparent axil-carousel slick-carousel-0 slick-initialized slick-slider slick-dotted">
            ...
            <div className="shape-group">
              <div className="shape shape-1">
                <Image
                  width={146}
                  height={71}
                  src="/images/others/shape-17.svg"
                  alt="Shape Image"
                />
              </div>
              <div className="shape shape-2">
                <Image
                  width={146}
                  height={71}
                  src="/images/others/shape-18.svg"
                  alt="Shape Image"
                />
              </div>
            </div>
